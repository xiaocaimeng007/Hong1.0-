package com.hongbao5656.view.kankan.wheel.widget;
 ...
 * 日期实体类，用于存储、获取选择的数据
 */
public class DateObjectPre extends Object{
	private int year ;
	private int month;
	private int day;
	private int week;
	 ...
	 * @author sxzhang
	 */
	public DateObjectPre(int year2, int month2, int day2, int week2) {
		super();
		this.year = year2;
		...
		this.week = week2 % 7 == 0 ? 7 : (week2 % 7 < 0 ? (week2 % 7+7) : week2 % 7);
...
//1 日  7 六    4 五
	 ...
	 * @author sxzhang
	 */
	public DateObjectPre(int hour2, int minute2, boolean isHourType) {
		super();
