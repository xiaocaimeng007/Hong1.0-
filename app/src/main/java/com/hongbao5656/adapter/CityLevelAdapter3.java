...
public class CityLevelAdapter3 extends BaseAdapter {
	private Context context;
	private List<String> cities;
//	private CitySupplyListener3 supplyListener;

	public CityLevelAdapter3(Context context, List<String> cities) {
