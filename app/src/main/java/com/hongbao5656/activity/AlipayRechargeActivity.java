...
public class AlipayRechargeActivity extends BaseActivity implements
        HttpDataHandlerListener, IWXAPIEventHandler {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_alipayrecgarge);
        setViews();
    }
...
//		payBtn.setEnabled(false);
        Toast.makeText(AlipayRechargeActivity.this, "获取订单中...", Toast.LENGTH_SHORT).show();
        try {
...
//					}
            ...
            Toast.makeText(AlipayRechargeActivity.this, "异常：" + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
...
//                ),AlipayRechargeActivity.this,false);
    }
...
//                        finish();
                        ...
                        if (TextUtils.equals(resultStatus, "8000")) {
                            Toast.makeText(AlipayRechargeActivity.this, "支付结果确认中", Toast.LENGTH_SHORT).show();
                        } else {
