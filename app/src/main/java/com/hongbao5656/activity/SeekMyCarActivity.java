 ...
 * 货源
 */
public class SeekMyCarActivity extends BaseActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_seekmycar);
        this.mContext = SeekMyCarActivity.this;
        initView();
        initMonitor();
        initDatas(cPage);
    }
    ...
    private void initDatas(int cPage) {
        sendPostRequest(
                Constants.seekmycar,
                new ParamsService().seekmycar(info, cPage),
                SeekMyCarActivity.this, false);
    }
    ...
    protected void initMonitor() {
        ...
        tv_start.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                dismissAll();
                Intent intent = new Intent(SeekMyCarActivity.this, SelectPlaceActivity.class);
                intent.putExtra("type", 1);
                intent.putExtra("shengfrom", shengfrom);
                intent.putExtra("shifrom", shifrom);
                intent.putExtra("xianqufrom", xianqufrom);
                SeekMyCarActivity.this.startActivityForResult(intent, 100);
            }
        });
        tv_end.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                SeekMyCarActivity.this.startActivityForResult(intent, 200);
            }
        });
        ...
        tv_cccx.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(final View view) {
                ...
                String[] ss = SPU.getPreferenceValueString
                        (SeekMyCarActivity.this, SPU.CARLEN, "",
                ...
                String[] ss2 = SPU.getPreferenceValueString
                        (SeekMyCarActivity.this, SPU.CARTYPE, "",
                                SPU.STORE_SETTINGS).split(",");
                ...
                if (cityLevelAdapter2 == null) {
                    cityLevelAdapter2 = new CityLevelAdapter2(SeekMyCarActivity.this, list);
                ...
                if (cityLevelAdapter3 == null) {
                    cityLevelAdapter3 = new CityLevelAdapter3(SeekMyCarActivity.this, list2);
...
//					}
    ...
    public void setHandlerPostDataSuccess(int connectionId, Object data) throws JSONException {
        ...
        if (connectionId == Constants.seekmycar) {
