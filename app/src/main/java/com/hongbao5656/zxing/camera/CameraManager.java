...
package com.hongbao5656.zxing.camera;
...
public final class CameraManager {
	...
	private CameraManager(Context context) {
		MIN_FRAME_WIDTH = dip2px(context, 240);
		MIN_FRAME_HEIGHT = dip2px(context, 240);
		MAX_FRAME_WIDTH = dip2px(context, 360);
		MAX_FRAME_HEIGHT = dip2px(context, 240);
