...
public class ReflectUtil {
	...
	/**
	 * 通锟斤拷锟斤拷,锟斤拷锟街革拷锟斤拷锟侥革拷锟斤拷姆锟斤拷筒锟斤拷锟斤拷实锟斤拷锟斤拷锟斤拷. 锟斤拷BuyerServiceBean extends
	 * DaoSupport<Buyer>
	 *
	 * @param clazz
	 *            clazz 锟斤拷要锟斤拷锟斤拷锟斤拷锟?锟斤拷锟斤拷锟斤拷锟教承凤拷锟酵革拷锟斤拷
	 * @param index
	 *            锟斤拷锟酵诧拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷,锟斤拷0锟斤拷始.
	 * @return 锟斤拷锟酵诧拷锟斤拷锟绞碉拷锟斤拷锟斤拷锟?
	 *         锟斤拷锟矫伙拷锟绞碉拷锟絇arameterizedType锟接口ｏ拷锟斤拷锟斤拷支锟街凤拷锟酵ｏ拷锟斤拷锟斤拷直锟接凤拷锟斤拷
	...
	public static Class getSuperClassGenricType(Class clazz, int index) {
		...
		// 锟斤拷锟截憋拷示锟斤拷锟斤拷锟斤拷实锟斤拷锟斤拷锟酵诧拷锟斤拷锟絋ype锟斤拷锟斤拷锟斤拷锟斤拷锟?锟斤拷锟斤拷锟斤拷诺亩锟斤拷嵌锟接︼拷锟斤拷偷锟紺lass,
		// 锟斤拷BuyerServiceBean extends
		// DaoSupport<Buyer,Contact>锟酵凤拷锟斤拷Buyer锟斤拷Contact锟斤拷锟斤拷
		Type[] params = ((ParameterizedType) genType).getActualTypeArguments();
		if (index >= params.length || index < 0) {
			throw new RuntimeException("锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟?"
					+ (index < 0 ? "锟斤拷锟斤拷小锟斤拷0" : "锟斤拷锟斤拷锟剿诧拷锟斤拷锟斤拷锟斤拷锟?"));
		}
	...
	/**
	 * 通锟斤拷锟斤拷,锟斤拷锟街革拷锟斤拷锟侥革拷锟斤拷牡锟揭伙拷锟斤拷锟斤拷筒锟斤拷锟斤拷实锟斤拷锟斤拷锟斤拷. 锟斤拷BuyerServiceBean extends
	 * DaoSupport<Buyer>
	 *
	 * @param clazz
	 *            clazz 锟斤拷要锟斤拷锟斤拷锟斤拷锟?锟斤拷锟斤拷锟斤拷锟教承凤拷锟酵革拷锟斤拷
	...
	/**
	 * 通锟斤拷锟斤拷,锟斤拷梅锟斤拷锟斤拷锟斤拷锟街碉拷锟斤拷筒锟斤拷锟斤拷实锟斤拷锟斤拷锟斤拷. 锟斤拷: public Map<String, Buyer>
	 * getNames(){}
	 *
	 * @param Method
	 *            method 锟斤拷锟斤拷
	...
	/**
	 * 通锟斤拷锟斤拷,锟斤拷梅锟斤拷锟斤拷锟斤拷锟街碉拷锟揭伙拷锟斤拷锟斤拷筒锟斤拷锟斤拷实锟斤拷锟斤拷锟斤拷. 锟斤拷: public Map<String, Buyer>
	 * getNames(){}
	 *
	 * @param Method
	 *            method 锟斤拷锟斤拷
	...
	/**
	 * 通锟斤拷锟斤拷,锟斤拷梅锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟絠ndex锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟叫凤拷锟酵诧拷锟斤拷锟绞碉拷锟斤拷锟斤拷锟? 锟斤拷: public void
	 * add(Map<String, Buyer> maps, List<String> names){}
	 *
	 * @param Method
	 *            method 锟斤拷锟斤拷
	 * @param int index 锟节硷拷锟斤拷锟斤拷锟斤拷锟斤拷锟?
	 * @return 锟斤拷锟斤拷锟斤拷锟侥凤拷锟酵诧拷锟斤拷锟绞碉拷锟斤拷锟斤拷图锟斤拷锟?
	 *         锟斤拷锟矫伙拷锟绞碉拷锟絇arameterizedType锟接口ｏ拷锟斤拷锟斤拷支锟街凤拷锟酵ｏ拷锟斤拷锟斤拷直锟接凤拷锟截空硷拷锟斤拷
	 */
	@SuppressWarnings("unchecked")
	...
	/**
	 * 通锟斤拷锟斤拷,锟斤拷梅锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟揭伙拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷锟斤拷蟹锟斤拷筒锟斤拷锟斤拷实锟斤拷锟斤拷锟斤拷. 锟斤拷: public void
	 * add(Map<String, Buyer> maps, List<String> names){}
	 *
	 * @param Method
	 *            method 锟斤拷锟斤拷
